	...
	return (
		<main className="min-h-screen flex items-center justify-center bg-[#f8fafc]">
			<div className="bg-white rounded-xl border p-8 shadow-md max-w-sm w-full">
				<h1 className="text-2xl font-bold mb-6 text-[#2d1a10]">Login</h1>
				<form className="space-y-4">
					...
					<div>
						...
						<input className="w-full border rounded px-3 py-2" type="password" placeholder="Enter your password" required />
					</div>
